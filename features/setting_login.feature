...
Feature: Setting login
  ...
  Scenario: Picking a nickname from the creation form
  ...
  Scenario: Trying to set login to a value that starts with autogenerated marker from the creation form
    When I go to the "take the test" page
    And I fill in "person[mindapples_attributes][0][suggestion]" with "Playing the piano"
  ...
  @current
  Scenario: Trying to set login to a value that starts with an underscore from the creation form
    When I go to the "take the test" page
    And I fill in "person[mindapples_attributes][0][suggestion]" with "Playing the piano"
    And I fill in "Join us. Choose a username" with "_pluk"
    And I press "Submit"
    Then I should see "Login can not start with an underscore"
    And I should see a "person[login]" text field
