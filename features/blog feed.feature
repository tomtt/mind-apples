...
Scenario: Feed contain proper values
  Given mind apple feed from the url "http://mindapples.org/feed"
  ...
  And I should see "Posted on 31 May 2010"
  And I should see "Posted by 21awake"
  ...
  And I should see "Posted on 12 May 2010"
  And I should see "Posted by Andy Gibson"
  ...
  And I should see "Posted on 20 Apr 2010"
  And I should see "Posted by Andy Gibson"
